...
namespace Flashcard
{
    ...
    {
        private CGPath tickMarks;
        private CGPath hourHand;
        private CGPath minuteHand;
        private CGPath secondHand;
        ...
        public ClockView(RectangleF bounds) : base(bounds)
        {
            Initialize();
        }
        ...
        public void SetClockHandAngles(ClockQuestion question)
        {
            SetClockHandAngles(question.HourAngle, question.MinuteAngle);
        }

        public void SetClockHandAngles(float hourAngle, float minuteAngle)
        {
